...
function ThreadsIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.03-3.579.879-6.43 2.525-8.482C5.851 1.205 8.604.024 12.186 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-.505-1.808-1.403-3.219-2.617-4.5C16.488 2.377 14.663 1.839 12.2 1.82c-2.682.023-4.814.98-6.337 2.843-1.52 1.86-2.31 4.342-2.334 7.367.024 3.024.814 5.506 2.334 7.367 1.523 1.863 3.655 2.82 6.337 2.843 2.338-.024 3.898-.573 5.14-1.86 1.132-1.17 1.87-2.865 2.178-5.034-.883.148-1.822.22-2.805.22-4.586 0-7.883-2.58-7.883-6.156 0-3.245 2.578-5.8 6.498-5.8 4.487 0 6.913 2.924 6.913 8.27.001 4.8-2.404 8.922-7.055 8.922zm.066-10.28c.892 0 1.738-.107 2.52-.31-.33-3.044-2.033-4.83-4.468-4.83-1.975 0-3.238 1.237-3.238 2.97 0 2.098 2.045 3.27 4.734 3.27l.452-.1z" />
    </svg>
  );
}
